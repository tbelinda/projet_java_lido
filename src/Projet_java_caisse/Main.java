...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < plats.length(); i++) catalogue.add(new Plat(plats.getJSONObject(i)));
        ...
        for (int i = 0; i < boissons.length(); i++) catalogue.add(new Boisson(boissons.getJSONObject(i)));
